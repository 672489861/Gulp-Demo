angular.module('app.contract.material.lease')
    .factory("MaterialLeaseService", ['YTService', 'UserService', function (YT, userService) {
        var serviceData = [],
            pageIndex = 0,
            pageSize = 10,
            hasNextPage = true,
        ...
        return {
            ...
            queryMaterial: function (id, successCallback) {
                var data = {
                    m: 6001004,
                    t: 'contract_materialleasing_info'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryCharges: function (id, successCallback) {
                var data = {
                    m: 6001004,
                    t: 'v_contract_materialleasing_charges'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryInvoice: function (id, successCallback) {
                var data = {
                    m: 6001004,
                    t: 'v_contract_materialleasing_taxinvoice'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryAttach: function (id, successCallback) {
                var data = {
                    m: 6001004,
                    t: 'contract_materialleasing_attach'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
