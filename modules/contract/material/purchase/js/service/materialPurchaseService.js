angular.module('app.contract.material.purchase')
    .factory("MaterialPurchaseService", ['YTService', 'UserService', function (YT, userService) {
        var serviceData = [],
            pageIndex = 0,
            pageSize = 10,
            hasNextPage = true,
        ...
        return {
            ...
            queryMaterial: function (id, successCallback) {
                var data = {
                    m: 6001003,
                    t: 'contract_materialpurchase_info'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryCharges: function (id, successCallback) {
                var data = {
                    m: 6001003,
                    t: 'v_contract_materialpurchase_charges'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryInvoice: function (id, successCallback) {
                var data = {
                    m: 6001003,
                    t: 'v_contract_materialpurchase_taxinvoice'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
            ...
            queryAttach: function (id, successCallback) {
                var data = {
                    m: 6001003,
                    t: 'contract_materialpurchase_attach'
                };
                var filter = [{field: 'id', value: id, operator: '=', relation: 'and'}];
                data.filter = JSON.stringify(filter);
