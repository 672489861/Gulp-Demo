angular.module('app.device.inspection.inspection-record')
    .factory("RecordService",['YTService','UserService',function(YT,userService){
        var recordList = [],
            pageIndex = 0,
            pageSize = 10,
            hasNextPage = true,
        ...
        return{
            ...
            getAttaches:function (id,callback) {
                var filter = [{field:'id',value:id,operator:'=',relation:''}];
                YT.query({
                    data:{m:12003001003,t:'device_inspection_attach',order:'typeId',filter:JSON.stringify(filter)},
                    successCallback:function (data) {
